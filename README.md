...
A modern and intuitive task management application built with Android Studio and Kotlin. This agenda app helps users organize their daily tasks with a clean, user-friendly interface.
